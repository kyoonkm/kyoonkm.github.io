...
export default function ProjectsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-backgroundCream" id="projects">
      <div className="max-w-6xl mx-auto px-6">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
        }`}>
          <h2 className="text-5xl font-bold text-textGrayCustom mb-4">Projects</h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="space-y-6">
                ...
                <h3 className="text-3xl font-bold text-textGrayCustom">{project.title}</h3>
                <p className="text-lg text-textGrayCustom leading-relaxed">{project.description}</p>

                <div className="flex space-x-4 pt-4">
                  <Link href={`/projects#${project.id}`}>
                    <span className="text-textGrayCustom hover:text-gray-600 transition-colors cursor-pointer font-medium">
                      Learn More
                    </span>
                  </Link>
                  <span className="text-gray-700 hover:text-textGrayCustom transition-colors cursor-pointer whitespace-nowrap">
        ...
        <div className="mt-20 text-center">
          <Link href="/projects">
            <span className="inline-flex items-center text-textGrayCustom hover:text-gray-600 transition-colors cursor-pointer text-lg font-medium relative group">
              View All Projects
