        ...
        <div className="max-w-4xl mx-auto">
          <div className={`text-center space-y-8 transform transition-all duration-1000 ${
            ...
            <div className="space-y-6">
              ...
              <p className="text-base leading-relaxed max-w-4xl mx-auto">
                Currently, I'm working as a student researcher in <a href="https://is.mpg.de/rml" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline"></a> Robust Machine Learning group at <a href="https://institute-tue.ellis.eu/en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline"></a>ELLIS Institute Tübingen. Previously, I was a research intern at Porsche Human-Centered AI Research and <a href="https://www.bosch-ai.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Bosch Research (BCAI)</a>. I also worked as a research assistant at the <a href="https://uni-tuebingen.de/fakultaeten/wirtschafts-und-sozialwissenschaftliche-fakultaet/faecher/fachbereich-sozialwissenschaften/methodenzentrum/institut/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Methods Center</a> at the University of Tübingen. I studied Sociology and Computer Science during my bachelor's degree, which laid the foundation for my interdisciplinary research. I worked on exciting projects at{' '}
